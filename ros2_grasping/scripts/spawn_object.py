...
def main():
    ...
    marker.scale.y = 0.05
    marker.scale.z = 0.063
    marker.color.a = 1.0
    marker.color.r = 1.0
    marker.color.g = 0.0
    marker.color.b = 0.0
    # marker.mesh_resource = "install/panda_ros2_gazebo/share/panda_ros2_gazebo/meshes/apple2.stl" #'package://' + args.package + '/urdf/' + args.urdf  # Adjust if needed
